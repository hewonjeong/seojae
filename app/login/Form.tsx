...
export default function Login() {
  ...
  return (
    <div>
      <h1
        className={`${montserrat.variable} font-montserrat text-[2.5rem] font-black leading-tight flex justify-center mt-20`}
      >
        Welcome to Seójae.
      </h1>
      <div className="mt-20 flex justify-center">
        <button
          className="w-72 p-2 flex justify-center gap-4 rounded-md border border-gray-400 hover:bg-gray-200"
          onClick={handleClick}
        >
          <svg
            width="24"
